    ...
    Column(
        ...
        CheckItem(
            modifier = Modifier
                .align(Alignment.Start)
                .padding(top = 6.dp),
            res = R.string.details_direction,
            style = MTheme.type.highlightTitle.fontSize(18.sp),
        )
        ...
        DeviceShape(
            ...
            Box(
                ...
                Image(
                    painter = painterResource(id = R.drawable.onboarding_details),
